...
* `GET /items` now accepts a new `filter` query parameter, currently only allowing `inProgress` value
* Add new frontend page for currently watching items using the new query param 
